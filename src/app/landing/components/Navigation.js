...
export default function Navigation() {
  ...
  return (
    <nav className="fixed top-0 z-50 w-full bg-[var(--color-surface)]/80  border-b border-[rgba(15,0,0,0.12)]">
      <div className="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
        ...
        >
          <div className="flex items-center justify-center w-9 h-9 rounded bg-gradient-to-br from-primary to-primary-hover text-white  bg-[rgba(0,122,255,0.2)]">
        ...
        <div className="flex items-center gap-4">
          <button 
            ...
            className="hidden sm:flex h-9 items-center justify-center rounded px-5 bg-[var(--color-primary)] hover:bg-[var(--color-primary)]-hover transition-all text-white text-sm font-semibold  bg-[rgba(0,122,255,0.25)]"
          >
            Get Started
          </button>
          <button 
            className="md:hidden p-2 rounded text-[var(--color-text-muted)] hover:text-[var(--color-text-main)] hover:bg-[var(--color-bg-alt)]-alt transition-colors"
      ...
      {mobileMenuOpen && (
        <div className="md:hidden border-t border-[rgba(15,0,0,0.12)] bg-[var(--color-surface)]/95 ">
          <div className="flex flex-col gap-4 p-6">
            ...
            <button 
              onClick={() => router.push("/dashboard")}
              className="h-10 rounded bg-[var(--color-primary)] hover:bg-[var(--color-primary)]-hover text-white text-sm font-semibold"
            >
              Get Started
            </button>
          </div>
