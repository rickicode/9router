      ...
      <div className="max-w-7xl mx-auto">
        <div className="flex flex-col lg:flex-row gap-16 items-start">
          ...
          <div className="flex-1 w-full">
            <div className="rounded overflow-hidden bg-zinc-900 border border-[rgba(15,0,0,0.12)] ">
              {/* Terminal header */}
              <div className="flex items-center gap-2 px-4 py-3 bg-zinc-800/50 border-b border-[rgba(15,0,0,0.12)]">
                <div className="w-3 h-3 rounded bg-[#ff3b30]/80"></div>
