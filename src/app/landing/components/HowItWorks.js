...
export default function HowItWorks() {
  return (
    <section className="py-24 border-y border-[rgba(15,0,0,0.12)] bg-[var(--color-bg-alt)]-alt" id="how-it-works">
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 relative">
          {/* Connection line */}
          <div className="hidden md:block absolute top-12 left-[16%] right-[16%] h-[2px] bg-gradient-to-r from-zinc-300 via-primary to-zinc-300 -z-10 opacity-30"></div>
          
          {/* Step 1: CLI & SDKs */}
          <div className="flex flex-col gap-6 relative group">
            <div className="w-20 h-20 rounded bg-[var(--color-surface)] border border-[rgba(15,0,0,0.12)] flex items-center justify-center  mx-auto md:mx-0 group-hover:border-[rgba(0,122,255,0.3)] group-hover: transition-all">
          ...
          <div className="flex flex-col gap-6 relative group md:items-center md:text-center">
            <div className="w-20 h-20 rounded bg-[var(--color-primary)]/10 border-2 border-primary flex items-center justify-center  bg-[rgba(0,122,255,0.2)] z-10 mx-auto">
