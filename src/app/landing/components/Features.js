...
const colorMap = {
  primary: { bg: "bg-[var(--color-primary)]/10", text: "text-[var(--color-accent)]", border: "hover:border-[rgba(0,122,255,0.3)]" },
  emerald: { bg: "bg-[rgba(48,209,88,0.1)]", text: "text-[var(--color-success)]", border: "hover:border-[rgba(48,209,88,0.3)]" },
  ...
  amber: { bg: "bg-[rgba(255,159,10,0.1)]", text: "text-[var(--color-warning)]", border: "hover:border-[rgba(255,159,10,0.3)]" },
...
export default function Features() {
  return (
    <section className="py-24 px-6 bg-[var(--color-bg-alt)]-alt" id="features">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
          {FEATURES.map((feature) => {
            ...
            return (
              <div 
                key={feature.title}
                className={`p-5 rounded bg-[var(--color-surface)] border border-[rgba(15,0,0,0.12)] ${c.border} hover:bg-[var(--color-surface)]/80 transition-all duration-200 group`}
              >
