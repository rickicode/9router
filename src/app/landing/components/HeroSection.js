  ...
  return (
    <section className="relative pt-24 pb-20 px-6 min-h-[85vh] flex flex-col items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 max-w-4xl w-full text-center flex flex-col items-center gap-8 animate-fade-in">
        {/* Version badge */}
        <div className="inline-flex items-center gap-2 rounded border border-[rgba(15,0,0,0.12)] bg-[var(--color-surface)]/80  px-4 py-1.5 text-sm font-medium text-[var(--color-text-muted)] ">
        ...
        <div className="flex flex-wrap items-center justify-center gap-4 w-full mt-4">
          <button className="h-11 px-8 rounded bg-[var(--color-primary)] hover:bg-[var(--color-primary)]-hover text-white text-sm font-semibold transition-all  bg-[rgba(0,122,255,0.25)] flex items-center gap-2 active:scale-[0.99]">
          ...
          <a 
            ...
            className="h-11 px-8 rounded border border-[rgba(15,0,0,0.12)] bg-[var(--color-surface)] hover:bg-[var(--color-bg-alt)]-alt text-[var(--color-text-main)] text-sm font-semibold transition-all flex items-center gap-2"
          >
        ...
        {/* Quick stats */}
        <div className="flex items-center gap-8 mt-8 pt-8 border-t border-[rgba(15,0,0,0.12)]">
