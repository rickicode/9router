...
export default function Footer() {
  return (
    <footer className="border-t border-[rgba(15,0,0,0.12)] bg-[var(--color-surface)] pt-16 pb-8 px-6">
      <div className="max-w-7xl mx-auto">
        ...
        {/* Bottom */}
        <div className="border-t border-[rgba(15,0,0,0.12)] pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
