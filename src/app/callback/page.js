  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-[var(--color-bg-alt)]">
      <div className="text-center p-8 max-w-md">
        {status === "processing" && (
          <>
            <div className="size-16 mx-auto mb-4 rounded bg-[var(--color-primary)]/10 flex items-center justify-center">
              <span className="material-symbols-outlined text-3xl text-[var(--color-accent)] animate-spin">progress_activity</span>
            </div>
            <h1 className="text-xl font-semibold mb-2">Processing...</h1>
            <p className="text-[var(--color-text-muted)]">Please wait while we complete the authorization.</p>
          </>
        )}
        ...
        {status === "manual" && (
          <>
            <div className="size-16 mx-auto mb-4 rounded bg-yellow-100 dark:bg-yellow-900/30 flex items-center justify-center">
            ...
            <div className="bg-[var(--color-surface)] border border-[rgba(15,0,0,0.12)] rounded p-3 text-left">
